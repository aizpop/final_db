                ...
                <div class="container-fluid">
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                            <a href="dashboard_pastreview_product.html" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
                                <i class="fa-sharp fa-solid fa-house fa-sm" style="color: #000000;">&nbsp&nbsp</i>Product</a>
                            </li>
                            <li class="nav-item">
                            	<a href="dashboard_pastreview_service.html" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
