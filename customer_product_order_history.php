...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/customer_product_order_history.css">
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
            <a href="customer_product_order_history.php" class="active">
                ...
                <div class="container-fluid">
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                            <a href="dashboard_orderhistory_product.html" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
                                <i class="fa-sharp fa-solid fa-house fa-sm" style="color: #000000;">&nbsp&nbsp</i>Product</a>
                            </li>
                            <li class="nav-item">
                            	<a href="dashboard_orderhistory_service.html" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr class="name">
                      ...
                      <td>₱300</td>
                      <td><button class="btn btn-primary">Order Again</button></td>
                      <td>
                        <a href="#">
                          <span>
