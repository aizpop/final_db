    ...
    <body style="padding-top: 0px;">
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="home.html">Hardware N.I.</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                            <a href="home.html" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a href="product_cart.html" class="dropdown-item">Products</a></li>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: right;">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="customer_product_order.php">Dashboard</a></li>
                ...
                <div class="container-fluid" style="text-align: center;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <p>And lastly this, the third column of representative placeholder content.</p><br><br><br>
                        </div><!-- /.col-lg-4 -->
                        <div>
                            <p><a href="product.html" class="btn btn-secondary"style="background-color: #F09E00; border: 0px;">See More &raquo;</a></p>
                        </div>
                    </div><!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <div>
                            <p><a href="service.html" class="btn btn-secondary"style="background-color: #F09E00; border: 0px;">See More &raquo;</a></p>
                        </div>
                    </div><!-- /.row -->
        ...
        <footer class="border-top footer text-muted">
            <div class="container" style="text-align: center;">
                &copy; 2023 - <a href="home.html" style="text-decoration: none; color: gray;">Hardware Necessary Items</a>
            </div>
        </footer>
